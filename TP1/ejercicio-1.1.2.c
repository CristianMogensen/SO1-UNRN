...
// Ahora bien, si se encuentra definida la variable de enntorno DATE_FORMAT, esta deberá contener
// el formato en que se debe imprimir, y el programa deberá utilizar el formato definida en ella.
...
int main(int argc, char* argv[]) {
    ...
    if (existe_var) {
        ...
        char formato_default[] = "YYYY-MM-DD";
        strcpy(resultado, formato_default);
    }

    validar_fecha(resultado);
    printf("%s", resultado);
