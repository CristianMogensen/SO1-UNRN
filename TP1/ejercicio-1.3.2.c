...
// 
// Agregue al programa anterior un nuevo parámetro -h, que explique el funcionamiento del
// programa y los parámetros que acepta.
...
/**
 * @brief Muestra el error que no se ha insertado el argumento -f o -h al
 * ingresar argumentos.
 * 
 * @return int 2 
 */
int display_error_args() {
    ...
    printf("Se espera el primer argumento:\n");
    printf("\t\"-f\" seguido del DATE_FORMAT para imprimir la fecha y hora actuales en ese formato.\n");
    printf("\t\"-h\" para mostrar la ayuda.\n");
    return 2;
}
...
int display_ayuda() {
    ...
    printf("Este programa muestra la fecha y hora en un formato determinado. El formato será el siguiente:\n\n");
    printf(" - Si no ingresa argumentos, se verificará la variable de entorno DATE_FORMAT. Si está definida se utilizará su formato, y sino, se utilizará por defecto el formato ISO8601 \"YYYY-MM-DDTHH-mm-SS\"\n");
    printf(" - Si ingresa argumentos deben ser los siguientes:\n");
    printf("\t- \"-f\" para especificar un formato seguido del argumento.\n");
    printf("\t- \"-h\" para mostrar esta ayuda.\n");
